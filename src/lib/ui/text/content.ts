  ...
  he: {
    ...
    about: {
      ...
      bio: [
        ...
        "שמי זואי ברקן - אמא לילד וגרה בחוף הכרמל.",
  "תמיד לומדת, תמיד בתנועה.",
  " הסקרנות תמיד מובילה אותי למקומות טובים ואת האיכות הזו אני מביאה לכל מקום.",
      "כדי שהאתר ישקף את המהות שלכם כעצמאיים/עמותה - אני לומדת אתכם, שואלת ומכוונת. אחר כך אני מארגנת את התוכן לשפה שתוכל להגיע ללב של הקהל שלכם.",
      ...
      skills: [
        "פיתוח אתרים ב-Wix",
        "פיתוח אתרים ב-WordPress",
        "עמודי נחיתה",
        "אוטומציות וניהול לידים",
        "עיצוב רספונסיבי",
        "עיצוב Canva",
        "עריכת וידאו",
      ],
    ...
    process: {
      ...
      intro:
        "תהליך שלם- מהרעיון ועד לאתר שיעשה לכם שקט, בליווי קרוב לאורך כל הדרך.",
      steps: [
        {
          title: "מתחילים בשיחת איפיון",
          description:
        ...
        {
          title: "נפגשים לדבר על הסקיצה",
          description:
            "עושות משוב (בזום) ואוספות רשימת הערות ומחשבות. תיקונים וסידורים אחרונים: אוטומציות, פרטים, פייפליין ללידים, נגישות, פרטיות, SEO.",
        },
        {
          title: "יוצאים לדרך",
          description:
    ...
    footer: {
      ...
      copyright: "© 2026 כל הזכויות שמורות לזואי ברקן",
    },
    notFound: {
      title: "אופס!",
