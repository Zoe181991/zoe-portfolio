...
export function MobileNav() {
  return (
    <div className="flex  flex-col  items-center text-center w-full  ">
      ...
      <div className="py-2 w-full text-[#ca74a3] hover:bg-[#c974a3]  hover:text-base-1 font-semibold text-base-4 hover:scale-125 hover:cursor-pointer  transition ease-in-out duration-300">
        <a
