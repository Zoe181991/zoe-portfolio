...
export default function Home() {
  ...
  const imagesURLS = [{text:"photo1", url:"../../../../public/svg/mailIcon.svg"}, {text:"photo2", url:"../../../../public/svg/githubIcon.svg"}, {text:"photo3", url:"../../../../public/svg/likedinIcon.svg"}]
  return (
    <>
      <Navbar />
      ...
      <main className="flex flex-col bg-body-bg-dots ">
        <div className="bg-body-bg-shapes scroll-smooth h-screen flex	">
          <div className="w-full flex flex-row justify-center p-24  max-h-fit min-h-10 ">
            <div className="w-full max-w-desktop flex flex-col lg:flex-row grow gap-4">
