          ...
          <div className="w-full flex flex-col justify-center pt-8 pb-24 px-12 md:px-24  max-h-fit min-h-10 mb-8 ">
            ...
            <div className="w-full flex justify-between flex-col lg:flex-row mt-8 gap-4 lg:gap-8">
              ...
              <div className="flex flex-col basis-2/5  gap-8 text-white">
                <div className="flex gap-2  lg:gap-4  w-full h-24 md:h-16">
                  <a
                    className="w-full"
                    href="https://pet-app-fe.vercel.app/"
                    target={"_blank"}
                  >
                    <div className="h-full w-full flex-col md:flex-row gap-1 md:gap-8 justify-between md:justify-center items-center hover:bg-base-5 hover:bg-opacity-60   border-base-2 border-2 hover:cursor-pointer hover:transition hover:transition-all hover:ease-in-out hover:duration-150 hover:scale-105 flex-row flex text-lg font-extrabold text-base-2 rounded-md px-4 py-2 ">
                      <Image
                        src={petAppLogo}
                        width={70}
                        height={70}
                        alt={"logo"}
                      />
                      <div className="text-sm md:text-lg ">Live ❯</div>
                    </div>
                  </a>
                  ...
                  >
                    <div className="h-full w-full flex-col md:flex-row gap-1 md:gap-8 justify-between md:justify-center items-center hover:bg-base-5 hover:bg-opacity-60   border-base-2 border-2 hover:cursor-pointer hover:transition hover:transition-all hover:ease-in-out hover:duration-150 hover:scale-105 flex-row flex text-lg font-extrabold text-base-2 rounded-md px-4 py-2 ">
                      ...
                      <div className="text-sm md:text-lg">Code ❯</div>
                    </div>
                  </a>
                </div>
                <p>
